...
RSpec.describe Account, type: :model do # rubocop:disable Metrics/BlockLength
  ...
  describe 'associations and dependent destroy' do
    ...
    it 'destroys associated projects, users, tables, templates, and mail_logs' do
      ...
      create_project(account: account, user: user)
      account.tables.create!(name: 'Test Table')
      account.templates.create!(name: 'Test Template')
      account.mail_logs.create!(to: 'dest@example.com', subject: 'Test', message_id: '123')
